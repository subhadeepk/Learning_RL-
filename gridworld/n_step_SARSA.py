...
def update_Q(episode, Q, gamma, alpha, sarsa_n): #updates the Q[state][action] function at the end of each episode
...
Q = [[250 for _ in range(nactions)] for _ in range(nstates)] 
...
for i in range (0,M):
    ...
    for _ in range(MAX_STEPS):
        ...
        Q = update_Q(episode, Q, gamma, alpha, sarsa_n)
